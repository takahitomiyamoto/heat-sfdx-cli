...
heat-sfdx-cli/0.2.4 darwin-x64 node-v16.13.1
$ sfdx --help [COMMAND]
USAGE
  $ sfdx COMMAND
...
...
_See code: [src/commands/heat/convert/xml2json.ts](https://github.com/takahitomiyamoto/heat-sfdx-cli/blob/v0.2.4/src/commands/heat/convert/xml2json.ts)_
...
_See code: [src/commands/heat/manifest/build.ts](https://github.com/takahitomiyamoto/heat-sfdx-cli/blob/v0.2.4/src/commands/heat/manifest/build.ts)_
...
_See code: [src/commands/heat/org.ts](https://github.com/takahitomiyamoto/heat-sfdx-cli/blob/v0.2.4/src/commands/heat/org.ts)_
...
_See code: [src/commands/heat/spec/apex/build.ts](https://github.com/takahitomiyamoto/heat-sfdx-cli/blob/v0.2.4/src/commands/heat/spec/apex/build.ts)_
...
EXAMPLE
  ...
  $ sfdx heat:tooling:get:execute --apiversion 54.0 -u myOrg@example.com -d .logs -f result.txt -r 
  /tooling/sobjects/Profile/describe
```

_See code: [src/commands/heat/tooling/get/execute.ts](https://github.com/takahitomiyamoto/heat-sfdx-cli/blob/v0.2.4/src/commands/heat/tooling/get/execute.ts)_
<!-- commandsstop -->
