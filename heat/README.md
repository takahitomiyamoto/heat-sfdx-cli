...
heat-sfdx-cli/0.1.0 darwin-x64 node-v14.17.0
$ sfdx --help [COMMAND]
USAGE
  $ sfdx COMMAND
...
...
_See code: [src/commands/heat/manifest/build.ts](https://github.com/takahitomiyamoto/heat-sfdx-cli/blob/v0.1.0/src/commands/heat/manifest/build.ts)_
...
_See code: [src/commands/heat/org.ts](https://github.com/takahitomiyamoto/heat-sfdx-cli/blob/v0.1.0/src/commands/heat/org.ts)_
<!-- commandsstop -->
