...
heat-sfdx-cli/0.2.5 darwin-x64 node-v16.13.1
$ sfdx --help [COMMAND]
USAGE
  $ sfdx COMMAND
...
...
<!-- usagestop -->
<!-- commands -->
* [`sfdx heat:convert:json2csv [-e <string>] [-i <string>] [-o <string>] [--header] [-c <string>] [-k <string>] [--verbose] [--json] [--loglevel trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]`](#sfdx-heatconvertjson2csv--e-string--i-string--o-string---header--c-string--k-string---verbose---json---loglevel-tracedebuginfowarnerrorfataltracedebuginfowarnerrorfatal)
...
## `sfdx heat:convert:json2csv [-e <string>] [-i <string>] [-o <string>] [--header] [-c <string>] [-k <string>] [--verbose] [--json] [--loglevel trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]`
...
_See code: [src/commands/heat/convert/json2csv.ts](https://github.com/takahitomiyamoto/heat-sfdx-cli/blob/v0.2.5/src/commands/heat/convert/json2csv.ts)_
...
_See code: [src/commands/heat/convert/xml2json.ts](https://github.com/takahitomiyamoto/heat-sfdx-cli/blob/v0.2.5/src/commands/heat/convert/xml2json.ts)_
...
_See code: [src/commands/heat/manifest/build.ts](https://github.com/takahitomiyamoto/heat-sfdx-cli/blob/v0.2.5/src/commands/heat/manifest/build.ts)_
...
_See code: [src/commands/heat/org.ts](https://github.com/takahitomiyamoto/heat-sfdx-cli/blob/v0.2.5/src/commands/heat/org.ts)_
...
_See code: [src/commands/heat/spec/apex/build.ts](https://github.com/takahitomiyamoto/heat-sfdx-cli/blob/v0.2.5/src/commands/heat/spec/apex/build.ts)_
...
_See code: [src/commands/heat/tooling/get/execute.ts](https://github.com/takahitomiyamoto/heat-sfdx-cli/blob/v0.2.5/src/commands/heat/tooling/get/execute.ts)_
<!-- commandsstop -->
